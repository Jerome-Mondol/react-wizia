...
//   return (
//     <div>
//         <div className="card bg-[#002228] flex justify-between items-center px-30 py-20 text-white">
//             {CardData.map((data, key) => {
//                 return (
//                     <div className="card__item h-65" key={key}>
//                         <img src={data.img} alt="" className="w-12 h-12"/>
//                         <h3 className="text-2xl mt-5">{data.title}</h3>
//                         <p className="text-gray-400 w-96 text-xl mt-5">{data.description}</p>
//                     </div>
//                 )
//             })}
//         </div>
