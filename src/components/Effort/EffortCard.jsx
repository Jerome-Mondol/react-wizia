...
const EffortCard = () => {
  return (
    <div className="TrainingBox bg-[#002228] flex justify-center items-center w-full min-h-[80vh] px-6 md:px-0">
      <div
        className="Training w-full md:w-[90%] min-h-[90%] rounded-3xl flex flex-col md:flex-row justify-center md:justify-between items-center md:items-start p-6 md:p-12"
        style={{
          backgroundImage: `url(${BackgroundRight})`,
          backgroundSize: "cover",
          backgroundPosition: "left", // Default position for mobile
        }}
      >
        {/* Content Section */}
        <div className="TrainingText w-full md:w-[60%] text-white text-center md:text-left flex flex-col items-center md:items-start gap-5">
          ...
          <h1 className="text-3xl md:text-4xl italic text-cyan-400">
          ...
          <div className="Percentages mt-6 w-full flex justify-center md:justify-start">
            <Percentages />
          </div>
        </div>
      </div>
